...
validatejsonr is an R wrapper around an efficient C++ JSON Schema validator called 'rapidjson'. You can read more about 'rapodjson' here: https://github.com/miloyip/rapidjson. JSON files can be *well-formed* and/or *valid*. A well-formed JSON file conforms to the *syntactic* 
